...
for (const requiredText of ["Review data quality", "Asset naming variants", "Approve", "Keep raw value", "View evidence", "Raw asset label", "Applied normalized value", "Structured evidence map", "Accept suggestion"]) {
