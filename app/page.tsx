...
const qualityIssues = [
  { id: "asset", title: "Asset naming variants", severity: "High", source: "MSL Meeting Notes · 57 records", confidence: "High confidence", problem: "Four labels refer to the same asset: OVT-209, OVT 209, OVT209 and Orivus 209.", suggestion: "Normalize analysis labels to OVT-209 while preserving the raw source value." },
